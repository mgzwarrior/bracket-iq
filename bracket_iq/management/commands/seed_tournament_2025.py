...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        with transaction.atomic():
            ...
            region_seeds = {
                Region.SOUTH: {
                    1: "Auburn", 8: "Louisville", 9: "Creighton", 5: "Michigan",
                    12: "UC San Diego", 4: "Texas A&M", 13: "Yale", 6: "Mississippi",
                    3: "Iowa State", 14: "Lipscomb", 7: "Marquette", 10: "New Mexico",
                    2: "Michigan State", 15: "Bryant"
                },
                Region.EAST: {
                    1: "Duke", 8: "Mississippi State", 9: "Baylor", 5: "Oregon",
                    12: "Liberty", 4: "Arizona", 13: "Akron", 6: "BYU",
                    11: "VCU", 3: "Wisconsin", 14: "Montana", 7: "Saint Mary's",
                    10: "Vanderbilt", 2: "Alabama", 15: "Robert Morris"
                },
                Region.WEST: {
                    1: "Florida", 8: "Connecticut", 9: "Oklahoma",
                    5: "Memphis", 12: "Colorado State", 4: "Maryland", 13: "Grand Canyon",
                    6: "Missouri", 3: "Texas Tech", 14: "UNC Wilmington",
                    7: "Kansas", 10: "Arkansas", 2: "St. John's", 15: "Nebraska Omaha"
                },
                Region.MIDWEST: {
                    1: "Houston", 8: "Gonzaga", 9: "Georgia",
                    5: "Clemson", 12: "McNeese State", 4: "Purdue", 13: "High Point",
                    6: "Illinois", 3: "Kentucky", 14: "Troy", 7: "UCLA",
                    10: "Utah State", 2: "Tennessee", 15: "Wofford"
                }
            }
            ...
            for team1_name, team2_name, region, seed_num in first_four:
                ...
                game = Game.objects.create(
                    ...
                    seed2=seed_num,
                    team2=team2,
                    game_date=first_four_start + timedelta(hours=(game_number - 1) * 2.5)  # Games staggered by 2.5 hours
                )
                ...
                for seed1, seed2 in matchups:
                    ...
                    if (region, seed1) in first_four_games or (region, seed2) in first_four_games:
                        ...
                        game = Game.objects.create(
                            ...
                            game_date=round_of_64_start + timedelta(hours=len(games_per_region[region]))
                        )
            ...
            self.stdout.write(self.style.SUCCESS('Successfully seeded 2025 tournament data')) 