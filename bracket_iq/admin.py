...
class BracketIQAdminSite(AdminSite):
    ...
    def get_urls(self):
        urls = super().get_urls()
        custom_urls = [
            path('tournament/seed/', self.admin_view(self.seed_tournament_view), name='seed_tournament'),
        ]
    ...
    def seed_tournament_view(self, request):
                ...
                with transaction.atomic():
                    ...
                    for team_name in team_names:
                        ...
                        if teams.count() > 1:
                            ...
                            Team.objects.filter(name=team_name).exclude(id=first_team.id).delete()
        ...
        available_years = []
        commands_dir = os.path.join(settings.BASE_DIR, 'bracket_iq', 'management', 'commands')
...
class GameInline(admin.TabularInline):
    model = Game
    fields = ('round', 'region', 'game_number', 'team1', 'team2', 'winner', 'score1', 'score2', 'game_date')
...
class GameAdmin(admin.ModelAdmin):
    list_display = ('tournament', 'round', 'region', 'game_number', 'matchup', 'score_display', 'winner_display', 'game_date')
    ...
    def save_model(self, request, obj, form, change):
        ...
        if obj.winner:
            ...
            if obj.next_game:
                ...
                if next_game.team1 is None or next_game.team1 == obj.team1 or next_game.team1 == obj.team2:
...
class PredictionAdmin(admin.ModelAdmin):
    list_display = ('bracket', 'game', 'predicted_winner', 'is_correct', 'points_earned')
...
class GameAdmin(admin.ModelAdmin):
    list_display = ('get_tournament_display', 'get_round_display', 'region', 'game_number', 'get_matchup_display')
