...
class BracketologyDataService:
    ...
    def get_matchup_factors(
        ...
        if team1_stats and team2_stats:
            offensive_advantage = (
                team1_stats["offensive_efficiency"]
                - team2_stats["defensive_efficiency"]
            )
            defensive_advantage = (
                team1_stats["defensive_efficiency"]
                - team2_stats["offensive_efficiency"]
            )
            tempo_factor = abs(team1_stats["tempo"] - team2_stats["tempo"])
            experience_advantage = team1_stats["experience"] - team2_stats["experience"]
        else:
            offensive_advantage = defensive_advantage = tempo_factor = (
