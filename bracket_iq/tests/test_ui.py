...
from ..models import Tournament, SeedList
...
class UITests(TestCase):
    ...
    def test_home_page_ui_elements(self):
        ...
        self.assertContains(response, 'Your intelligent March Madness bracket assistant')
    ...
    def test_messages_styling(self):
        ...
        response = self.client.post(reverse('create_bracket_form'), {
