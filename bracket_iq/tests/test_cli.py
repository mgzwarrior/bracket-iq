...
from bracket_iq.models import Team, Round
...
class TestCLI(unittest.TestCase):
    ...
    def test_predict_matchup(self, mock_analyzer):
        ...
        mock_analyzer.return_value.get_matchup_analysis.return_value = self.sample_prediction["analysis"]
    ...
    def test_batch_predict(self, mock_predict):
        ...
        with tempfile.NamedTemporaryFile(mode='w', delete=False) as output_file:
            ...
            results = batch_predict(input_file.name, output_file.name, "HISTORICAL_ANALYSIS")
    ...
    def test_simulate_tournament(self, mock_predict):
        ...
        with tempfile.NamedTemporaryFile(mode='w', delete=False) as teams_file:
            teams_file.write(self.tournament_csv_content)
            teams_file.flush()
    ...
    def test_get_upset_probability(self, mock_analyzer):
        ...
        with self.assertRaises(ValueError):
            get_upset_probability(5, 4)   # Higher seed > lower seed

    @patch('bracket_iq.cli.HistoricalAnalyzer')
    def test_get_team_stats(self, mock_analyzer):
        """Test retrieving team statistics."""
        # Configure mock
        mock_analyzer.return_value.get_team_tournament_stats.return_value = self.sample_team_stats
    ...
    def test_main_invalid_command(self):
        ...
        with patch('argparse.ArgumentParser.parse_args') as mock_args:
            ...
            # Should return successfully after printing help
